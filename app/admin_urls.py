...
urlpatterns = [
    ...
    path('coupons/<int:pk>/', admin_views.CouponDetailView.as_view(), name='coupon_detail'),
    path('coupons/<int:pk>/edit/', admin_views.CouponUpdateView.as_view(), name='coupon_edit'),
    path('coupons/<int:pk>/delete/', admin_views.CouponDeleteView.as_view(), name='coupon_delete'),
    ...
    path('home-categories/<int:pk>/toggle-active/', admin_views.HomeCategoryToggleActiveView.as_view(), name='home_category_toggle_active'),
    path('home-categories/product-candidates/', admin_views.HomeCategoryProductCandidatesApiView.as_view(), name='home_category_product_candidates'),
    ...
    path('combos/<int:pk>/toggle-active/', admin_views.DashboardComboToggleActiveView.as_view(), name='combo_toggle_active'),
