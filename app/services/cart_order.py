...
def send_order_notification_email(order, request=None):
    try:
        ...
        try:
            ...
            pass
        context = {'order': order, 'order_url': order_url, 'payment_method': payment_method, 'site_name': ' Plants 99'}
        try:
...
def send_order_confirmation_email(order):
    try:
        ...
        context = {'order': order, 'site_name': 'Plants 99', 'status_key': status_key}
        try:
